...
%one step prediction
%Monte Carlo simulation with different kernel size for Gaussian kernel
%
%Usage:
%ch2, m-g prediction, tables 2-6
%
%Outside functions called:
%LMS1, KLMS1 and regularizationNetwork
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
