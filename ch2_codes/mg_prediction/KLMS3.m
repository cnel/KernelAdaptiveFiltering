function [expansionCoefficient,weightVector,biasTerm,learningCurve] = ...
    KLMS3(trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel,paramRegularization,stepSizeFeatureVector,stepSizeWeightVector,stepSizeBias,flagLearningCurve)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function KLMS3
%leaky KLMS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Output:
%expansionCoefficient:   consisting of coefficients of the kernel
%                           expansion
...
% forgetting term
forgettingTerm = 1 - paramRegularization*stepSizeFeatureVector;
if abs(forgettingTerm)>1
    disp('forgetting term warning');
end
...
for n = 2:trainSize
    ...
    % filtering
    ii = 1:n-1;
    networkOutput = expansionCoefficient(ii)'*...
    ...
    expansionCoefficient(ii) = expansionCoefficient(ii)*forgettingTerm;
