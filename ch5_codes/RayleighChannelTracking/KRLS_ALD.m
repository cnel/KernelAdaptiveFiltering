function [expansionCoefficient,dictionaryIndex,learningCurve,CI] = ...
    KRLS_ALD(trainInput,trainTarget,typeKernel,paramKernel,regularizationFactor,forgettingFactor,th1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function kernel recursive least squares approximate linear dependency
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Input:
