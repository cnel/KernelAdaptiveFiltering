...
for n = 2:trainSize
    ...
    predictionVar = regularizationFactor*forgettingFactor^(dictSize) + ker_eval(trainInput(:,n),trainInput(:,n),typeKernel,paramKernel) -...
        k_vector'*f_vector;
    ...
    if (CI(n,criterion) > th1 && CI(n,criterion) < th2)
        ...
        expansionCoefficient = expansionCoefficient - f_vector'*s*predictionError;
        dictSize = dictSize + 1;
