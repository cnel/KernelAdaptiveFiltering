function [expansionCoefficient,dictionaryIndex,learningCurve,CI] = ...
    AOGR1(trainInput,trainTarget,testInput,testTarget,typeKernel,paramKernel,regularizationFactor,forgettingFactor,th1,th2,flagLearningCurve)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function AOGR
...
CI(1) = log(predictionVar)/2 + predictionError^2/(2*predictionVar) + trainInput(:,1)^2/2;
...
for n = 2:trainSize
    ...
    CI(n) = log(predictionVar)/2 + predictionError^2/(2*predictionVar) - trainInput(:,n)^2/2;
